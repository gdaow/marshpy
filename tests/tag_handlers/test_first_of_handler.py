...
def _check_first_of_tag(
    yaml: str, expected_value: Any = None, expected_error: Optional[ErrorCode] = None
) -> None:
...
def test_first_of_tag_handler() -> None:
    ...
    _check_first_of_tag("!first-of [!fail value_1, !fail value_2, value_3]", "value_3")

    _check_first_of_tag(
        "!first-of [!fail value_1, !fail value_2, !fail value_3]", UNDEFINED
    )
...
def test_first_of_tag_handler_error_handling() -> None:
    ...
    _check_first_of_tag(
        "!first-of scalar_value", expected_error=ErrorCode.UNEXPECTED_NODE_TYPE
    )

    _check_first_of_tag("!first-of {}", expected_error=ErrorCode.UNEXPECTED_NODE_TYPE)
